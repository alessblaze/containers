...
export MARIADB_ENABLE_BACKUP="${MARIADB_ENABLE_BACKUP:-}"
export DB_ENABLE_BACKUP="$MARIADB_ENABLE_BACKUP"
export MARIADB_BACKUP_USER="${MARIADB_BACKUP_USER:-}"
export DB_BACKUP_USER="$MARIADB_BACKUP_USER" # only used during the first initialization
export MARIADB_BACKUP_PASSWORD="${MARIADB_BACKUP_PASSWORD:-}"
export DB_BACKUP_PASSWORD="$MARIADB_BACKUP_PASSWORD"
