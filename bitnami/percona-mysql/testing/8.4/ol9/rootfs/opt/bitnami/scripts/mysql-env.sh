...
export MYSQL_ENABLE_BACKUP="${MYSQL_ENABLE_BACKUP:-}"
export DB_ENABLE_BACKUP="$MYSQL_ENABLE_BACKUP"
export MYSQL_BACKUP_USER="${MYSQL_BACKUP_USER:-}"
export DB_BACKUP_USER="$MYSQL_BACKUP_USER" # only used during the first initialization
export MYSQL_BACKUP_PASSWORD="${MYSQL_BACKUP_PASSWORD:-}"
export DB_BACKUP_PASSWORD="$MYSQL_BACKUP_PASSWORD"
